...
3.3) Привести конфигурированиям nginx к конечному (или изначальному виду) виду с 443 портом и сертификатами. См. пример /etc/nginx/sites-avaliable/project.baz.nginx.conf
